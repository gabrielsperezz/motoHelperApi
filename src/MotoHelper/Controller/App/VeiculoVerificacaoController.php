...
class VeiculoVerificacaoController
{
    ...
    public function verificarVeiculo(Application $app)
    {
        ...
        if(!is_null($veiculo)){
            $response = $app['twig']->render('veiculo_autorizacao/veiculo_autorizacao_form.html.twig', ["veiculo" => $veiculo->toArray()]);
        }
        return $response;
    }
    ...
    {
        return $app['twig']->render('veiculo_autorizacao/veiculo_autorizacao_form_busca.html.twig' , ["veiculos" => $this->getVeiculosAVerificar($app['orm.em'])]);
    }

...
use MotoHelper\Entity\LoginAdministrador as LoginEntity;
...
class Login
{
    ...
    {
        return $app['twig']->render('admin/login/login.html.twig' , array());
    }
    ...
    public function logout( Application $app , Request $request )
    {
        ...
        $response->headers->clearCookie(Cookie::COOKIE_NAME_ADMIN);
        return $response;
    }
    ...
    private function createNewSession( Application $app , LoginEntity $user , Response $response )
    {
        ...
        $accessToken->setTipo(AccessToken::TIPO_ADMIN);
